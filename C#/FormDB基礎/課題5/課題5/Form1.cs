    ...
    public partial class Form1 : Form
    {
        ...
        private List<string[]> readDB(string dbPath)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "SELECT * FROM RESULT_TABLE WHERE @ENGP <= ENGLISH_POINT AND @MATHP <= MATHEMATICS_POINT";

                cmd.Parameters.Add("ENGP", System.Data.DbType.Int32);
                cmd.Parameters["ENGP"].Value = 70;
                cmd.Parameters.Add("MATHP", System.Data.DbType.Int32);
                cmd.Parameters["MATHP"].Value = 70;
