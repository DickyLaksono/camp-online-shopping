...
<body>
	...
	<div class="container mt-5 mb-3">
		<ul class="nav nav-tabs ">
		  ...
		  <li class="nav-item">
		    <a class="nav-link active" href="ItemInsertView.jsp">新規登録</a>
		  </li>
		  <li class="nav-item">
	...
	<div class="container my-3">
		<h1 class="display-3 text-center font-monospace fw-bold">新規登録</h1>
	</div>
	
	<div class="container">
		<form action="ItemInsertController" method="post">
			<label for="itemname" class="me-3 mt-3 mb-1">Item name :</label>
				<input class="form-control mb-2"id="itemname" type="text" name="itemname" placeholder="Item Name">
			
			<label for="price" class="me-3 mb-1">Price :</label>
				<input class="form-control mb-2"id="price" type="number" name="price" placeholder="Price">
			
			<label for="detail" class="me-3 mb-1">Detail :</label>
				<textarea class="form-control mb-2"id="detail"  name="detail" placeholder="Detail"></textarea>
			
			<label for="image" class="me-3 mb-1">Image :</label>
				<input class="form-control mb-2"id="image" type="text" name="image" placeholder="Image">
