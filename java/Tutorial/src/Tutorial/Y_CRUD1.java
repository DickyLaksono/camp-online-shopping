...
public class Y_CRUD1 {
	...
	private static void cariData() throws IOException {
		...
		try {
			File file = new File("database.txt");//ini untuk mengecek
		} catch (Exception e) {
		...
		String[] keywords = cariString.split("\\s+");//"\\" adalah wide space
														//ini juga bisa menggunakan tokenizer
	...
	private static void tambahData() throws IOException {
		...
		FileWriter fileOutput = new FileWriter("database.txt", true);//"true" ini untuk manambahkan file di belakannya(tidak akan menghapus file nya)
	...
	private static boolean getYesorNo(String message) {
		...
		return pilihanUser.equalsIgnoreCase("y"); //jika pilihannya selain "y" maka false
	}
