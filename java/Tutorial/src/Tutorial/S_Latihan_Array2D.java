...
public class S_Latihan_Array2D {

	public static void main(String[] args) {
		//syarat untuk menambahkan matrix ,jumlah nya harus sama
	...
	private static int[][] kali(int[][] matrix_1, int[][] matrix_2) {
		...
		//jika a * b maka jumlah baris akan mengikuti matrix_a,
	...
	private static void printarray(int[][] dataarray) {
		int baris = dataarray.length;//ini untuk mengambil jumlah baris
		int kolom = dataarray[0].length;//kita ambil komponennya(misalnya 0)
	...
	//-------------------------------------------------------------------------------------
	//*********** untuk perkalian dua matrix menggunakan perkalian aljabar linear ***********
